    ...
    public partial class AutoIndentSample : Form
    {
        ...
        private void cbAutoIndentType_SelectedIndexChanged(object sender, EventArgs e)
        {
            if(cbAutoIndentType.SelectedIndex == 0)//built-in C# AutoIndent
            {
                ...
                fastColoredTextBox1.AutoIndentNeeded -= new EventHandler<AutoIndentEventArgs>(fastColoredTextBox1_AutoIndentNeeded);
                fastColoredTextBox1.Text = @"/// Please, type next text:
/// int Foo()
/// {
/// int i=10;
/// label:
...
";
        ...
        void fastColoredTextBox1_AutoIndentNeeded(object sender, AutoIndentEventArgs e)
        {
